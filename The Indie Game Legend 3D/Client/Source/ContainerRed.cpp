...
CContainerRed::CContainerRed()
	: m_pTexturePool(nullptr)
{
}

CContainerRed::CContainerRed(const CContainerRed & other)
	: CGameObject(other)
{
}

HRESULT CContainerRed::InitializePrototype()
{
...
UINT CContainerRed::Update(const float _fDeltaTime)
{
...
void CContainerRed::OnCollision(CGameObject * _pGameObject)
{
...
HRESULT CContainerRed::IsBillboarding()
{
...
CGameObject * CContainerRed::Clone()
{
	CContainerRed* pClone = new CContainerRed(*this);
	return pClone;
}

CContainerRed * CContainerRed::Create()
{
	CContainerRed* pInstance = new CContainerRed();
	return pInstance;
}

void CContainerRed::Free()
{
