...
CSpreadGun::CSpreadGun()
	: m_pTexturePool(nullptr)
{
}

CSpreadGun::CSpreadGun(const CSpreadGun & other)
	: CGameObject(other)
{
}

HRESULT CSpreadGun::InitializePrototype()
{
...
UINT CSpreadGun::Update(const float _fDeltaTime)
{
...
UINT CSpreadGun::LateUpdate(const float _fDeltaTime)
{
...
void CSpreadGun::OnCollision(CGameObject * _pGameObject)
{

}

HRESULT CSpreadGun::IsBillboarding()
{
...
void CSpreadGun::Set_ItemPos(const _vector _vItemPos)
{
	m_pTransform->Set_Position(_vItemPos);
}


CGameObject * CSpreadGun::Clone()
{
	CSpreadGun* pClone = new CSpreadGun(*this);
	return pClone;
}

CSpreadGun * CSpreadGun::Create()
{
	CSpreadGun* pInstance = new CSpreadGun();
	return pInstance;
}

void CSpreadGun::Free()
{
