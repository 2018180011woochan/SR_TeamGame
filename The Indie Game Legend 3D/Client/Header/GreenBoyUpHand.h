#pragma once
#ifndef __GREENBOYUPHAND_H__

#include "Monster.h"
#include "TexturePoolManager.h"
USING(Engine)
class CGreenBoyUpHand final : public CMonster
{
private:
	explicit CGreenBoyUpHand();
	explicit CGreenBoyUpHand(const CGreenBoyUpHand& other);
	virtual ~CGreenBoyUpHand() = default;
...
#define __GREENBOYUPHAND_H__
#endif // !__GREENBOYUPHAND_H__
